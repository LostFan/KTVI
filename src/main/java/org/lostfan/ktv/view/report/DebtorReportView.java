...
import org.lostfan.ktv.model.DebtorReportModel;
...
public class DebtorReportView extends FormView {
    ...
    private class TariffFormField extends FormField<Integer> {
        ...
        public TariffFormField(String fieldKey) {
            ...
            this.panel.setParentView(DebtorReportView.this);
        }
    ...
    private DebtorReportModel model;
    ...
    private DoubleFormField sum;
    private TariffFormField tariffField;

    public DebtorReportView(DebtorReportModel model) {
        ...
        sum = new DoubleFormField("entity.sum");
        addFormField(sum);
        tariffField = new TariffFormField("tariff");
        addFormField(tariffField);
        ...
        this.addButton.addActionListener(e -> {
            ...
            validator.validate(dateField.getValue(), dateField.getFieldKey(),
                    validationResult);
            validator.validate(sum.getValue(), sum.getFieldKey(),
                    validationResult);
            ...
            reportTableModel = new ReportTableModel(
                    model.getData(dateField.getValue(), new BigDecimal(sum.getValue()), tariffField.getValue()));
        ...
        this.excelButton.addActionListener(e -> {
            ...
            new Thread(() -> {
                String message = model.generateExcelReport(dateField.getValue(),
                        new BigDecimal(sum.getValue()), tariffField.getValue());
                if (message != null) {
