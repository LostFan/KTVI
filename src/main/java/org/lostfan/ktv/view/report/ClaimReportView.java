...
import org.lostfan.ktv.model.ClaimReportModel;
...
public class ClaimReportView extends FormView {
    ...
    private class TariffFormField extends FormField<Integer> {
        ...
        public TariffFormField(String fieldKey) {
            ...
            this.panel.setParentView(ClaimReportView.this);
        }
    ...
    private ClaimReportModel model;
    ...
    public ClaimReportView(ClaimReportModel model) {
        ...
        this.addButton.addActionListener(e -> {
            ...
            reportTableModel = new ReportTableModel(
                    model.getData(dateField.getValue(), new BigDecimal(sum.getValue())));
