...
import org.lostfan.ktv.model.WriteOffReportModel;
...
public class WriteOffReportView extends FormView {
    ...
    private class TariffFormField extends FormField<Integer> {
        ...
        public TariffFormField(String fieldKey) {
            ...
            this.panel.setParentView(WriteOffReportView.this);
        }
    ...
    private WriteOffReportModel model;
    ...
    public WriteOffReportView(WriteOffReportModel model) {
